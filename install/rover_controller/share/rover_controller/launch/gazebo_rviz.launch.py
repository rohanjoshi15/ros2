...
def generate_launch_description():
    ...
    world_file = os.path.join(get_package_share_directory(package_name), 'model', 'rover_world_with_cones.world')
    ...
    spawn_entity = Node(
        ...
        arguments=['-entity', 'rover', '-topic', 'robot_description', '-x', '0', '-y', '0', '-z', '0.01'],
        output='screen'
    )
