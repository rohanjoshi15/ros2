...
: ${AMENT_CURRENT_PREFIX:="/home/rj/tasks_ws/src/install/number_square"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/number_square/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/number_square/environment/path.sh"
